...
class Ui_Capture(object):
    def setupUi(self, Capture):
        ...
        self.logo.setPixmap(QtGui.QPixmap(r"./static/logo_capture.png"))
        ...
        self.pushButton_7.clicked.connect(Capture.KWsearch)
    ...
    def retranslateUi(self, Capture):
        ...
        self.pushButton_6.setText(_translate("Capture", "流整理"))
        self.pushButton_7.setText(_translate("Capture", "关键字搜索"))
        self.pushButton_8.setText(_translate("Capture", ""))
